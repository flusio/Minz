...
class Controller
{
    ...
    public function watch(Request $request): \Generator
    {
        ...
        $stop_after = $request->params->getInteger('stop-after', 0);
        $sleep_duration = $request->params->getInteger('sleep-duration', 3);
        $queue = $request->params->getString('queue', 'all');
    ...
    {
        $job_id = $request->params->getInteger('id', 0);

...
class RequestTest extends TestCase
{
    public function testInitFromGlobals(): void
    {
        ...
        $this->assertSame('bar', $request->params->get('foo'));
        $this->assertSame('egg', $request->params->get('spam'));
        $this->assertSame('file', $request->params->get('some'));
    ...
    public function testInitFromCli(): void
    {
        ...
        $this->assertSame('./cli', $request->params->get('bin'));
        $this->assertSame('bar', $request->params->get('foo'));
        $this->assertSame('qux', $request->params->get('foo-baz'));
        $this->assertTrue($request->params->getBoolean('spam'));
    }
